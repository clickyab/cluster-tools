...
kubectl -n ingress-nginx set image deployment  default-http-backend default-http-backend=registry.clickyab.ae/clickyab/${APP}_${BRANCH}:${COMMITCOUNT} --record
kubectl -n monitoring set image deployment mysql-slave-monitor mysql-slave-monitor=registry.clickyab.ae/clickyab/${APP}_${BRANCH}:${COMMITCOUNT} --record
...
kubectl -n tools set image deployment cloud-monitor cloud-monitor=registry.clickyab.ae/clickyab/${APP}_${BRANCH}:${COMMITCOUNT} --record
kubectl -n tools set image deployment rabbit-monitor rabbit-monitor=registry.clickyab.ae/clickyab/${APP}_${BRANCH}:${COMMITCOUNT} --record
